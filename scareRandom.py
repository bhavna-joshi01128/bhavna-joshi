...
video_prefix = ["ChildScare.mp4"] # This is the list of videos prefixes, you can add additional video
# prefixes here.
video = ["omxplayer","UP-Living_Nightmare-Little_Girl", "-o", "both", "--win", "0 0 1280 720", "--aspect-mode", "fill", "--no-osd",
         "--orientation", "180", "--vol", "-600"]
record = ["raspivid", "-o", "UP-Living_Nightmare-Little_Girl", "-n", "-t", "5000", "-rot", "180"]
scare_file = "UP_Girl_LivingNightmare_Wall_H"
current_prefix = "ChildScare.mp4"
image_name = "UP_Girl_Buffer_Wall_H"
...
def change_video():
    ...
    if elapsed_time > (int(sys.argv[2]) * 60):
        scare_file = "/home/pi/Downloads/ScareMedia/{0}ScareV.m4v".format(current_prefix)
        start_time = time.time()
...
def show_image(_image_name):
    os.system("sudo fbi -T 1 -d /dev/fb0 -noverbose -once /home/pi/Downloads/ScareMedia/{0}Start.png".format(
        _image_name))
...
def start_up():
    ...
    global image_name
    image_name = arg1
    scare_file = "/home/pi/Downloads/ScareMedia/{0}ChildScare.m4v".format(image_name)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Usage: python ./scareRandom.py [UP-Living_Nightmare-Little_Girl] [00.14]")
        sys.exit(1)
    except ValueError as x:
        print(x.message + "\nUsage: python ./scareRandom.py [UP-Living_Nightmare-Little_Girl] [00.14]")
        sys.exit(1)
